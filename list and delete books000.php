...
<body>
    <script src=""></script>
    <h1>Project Gutenberg Australia, delete a book.</h1>
    ...
    <table id="customers">
        ...
        ?>
        <tr>
            <td><?php echo $row['title'].'<a href="deletebook.php?bookID='.$row['bookID'].'"onclick="return window.confirm(\'Are you sure you want to delete '.$row['title'].'?\');">Delete ?</a>';?>
            </td>
